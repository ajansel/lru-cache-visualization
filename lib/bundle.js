...
class LinkedList {
  ...
  render() {
    ...
    while (currentNode !== this.head) { // Aka the tail
      ...
      rightArrow = new RightArrow(x - 70 + 35, y - (70 / 4), "yellow");
      rightArrow.draw(this.ctx);

      leftArrow = new LeftArrow(x - 50 - 35, y + (70 / 4), "yellow");
...
const LinkedList = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./../linked_list_verticaly/linked_list_vertical\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
...
class LeftBracket {
  ...
  draw(ctx) {
    ...
    ctx.lineTo(this.xPos, this.yPos + 200);
    ctx.lineTo(this.xPos + 37.5, this.yPos + 200);
    ctx.stroke();
  }
}
